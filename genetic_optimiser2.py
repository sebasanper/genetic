...
result = open('gen6_best_layout_ainslie.dat', 'w', 1)
result2 = open('gen6_fitness_ainslie.dat', 'w', 1)
average = open('gen6_average_fitness_ainslie.dat', 'w', 1)
...
#  gen4 same as gen3, changed selection percentage to 0.2 instead of 0.3.
#  gen 6 same as gen4 with niter 50
